...
//         let result: Models.JobModels.IJobEntry<any>[];
...
//         const entryName = 'job';
//         const requestedJob: Models.JobModels.IJobEntry<any> = await this._getJobById(req.params.jobId);
//         if (validator
...
//         const entry: Models.JobModels.IJobEntry<any> = {
//             id: uuidv4(),
...
//         const requestedJob: Models.JobModels.IJobEntry<any> = await this._getJobById(req.body.id);
...
//     private async _getAllJobs(sortByDate: Models.Enums.SortBy, username?: string, limit?: number): Promise<Models.JobModels.IJobEntry<any>[]> {
//         const queryObj: any = {};
//         const optionObj: any = {
...
//     private async _getJobById(id: string): Promise<Models.JobModels.IJobEntry<any>> {
//         return await this.jobsCollection.findOne({ id });
//     }

//     private async _createNewJob(jobEntry: Models.JobModels.IJobEntry<any>): Promise<mongodb.InsertOneWriteOpResult> {
