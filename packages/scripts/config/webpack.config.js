...
module.exports = function (webpackEnv) {
    ...
    const customiseBaseConfiguration = (base) => {
        if (fs.existsSync(paths.serverSetup))
            base = require(paths.serverSetup)(base);
        if (fs.existsSync(paths.libSetup))
            base = require(paths.libSetup)(base);
        return base;
    };

    return {
        ...customiseBaseConfiguration(baseConfiguration),
                    ...
                    use: [
                        {
                            options: {
                                ...
                                // resolvePluginsRelativeTo: __direname,
