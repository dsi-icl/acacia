                ...
                <>
                    ...
                    <div className="page_content">
                        ...
                        <Subsection title="Datasets">
                            <ProjectSection study projects={data.getUsers[0].access.studies} />
                        </Subsection>
                    </div>
                </>
            );
        ...
        >
            {(submit, { loading, error, data }) => (
                <>
                    ...
                    <label>
                        Real name:
                        <input type="text" value={inputs.realName} onChange={(e) => { setInputs({ ...inputs, realName: e.target.value }); }} />
                    </label>
                    <br />
                    <br />
                    <label>
                    ...
                    <label>
                        Email Notification:
                        <input type="checkbox" checked={inputs.emailNotificationsActivated} onChange={(e) => { setInputs({ ...inputs, emailNotificationsActivated: e.target.checked }); }} />
                    </label>
                    <br />
                    <br />
                    <label>
                    ...
                    <label>
                        Organisation:
                        <input type="text" value={inputs.organisation} onChange={(e) => setInputs({ ...inputs, organisation: e.target.value })} />
                    </label>
                    <br />
                    <br />
                    <label>
                        Created by (readonly):
                        <input type="text" readOnly value={inputs.createdBy} />
                    </label>
                    <br />
                    <br />
                        ...
                        {(deleteUser, { loading: loadingUserDeletion, error: UserDeletion, data: UserDeletedData }) => {
                            ...
                            return (
                                <>
                                    ...
                                    {' '}
                                    {loading ? <p style={{ cursor: 'pointer', textDecoration: 'underline' }}> click here </p> : <p onClick={() => { setDeleteButtonShown(true); }} style={{ cursor: 'pointer', textDecoration: 'underline' }}> click here </p>}
                                    <br />
                                    {deleteButtonShown ? (
                                        <>
                                            <label>
                                                Are you sure about deleting user
                                                <i>{user.username}</i>
                                                ?
                                            </label>
                                            <br />
                                            {' '}
                                            <span onClick={() => { deleteUser({ variables: { userId: user.id } }); }} className={css.really_delete_button}>
                                                Delete user
                                                {user.username}
                                            </span>
                                            {' '}
                                            <span onClick={() => { setDeleteButtonShown(false); }} style={{ cursor: 'pointer' }}> Cancel </span>
                                        </>
                                    ) : null}
                                </>
                            );
