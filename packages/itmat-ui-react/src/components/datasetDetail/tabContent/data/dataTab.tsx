                ...
                {data.dataVersions.length >= 2 ? (
                    <>
                        <div>
                            ...
                            <h5>
                                Linear history
                                <InfoCircle className={css.infocircle} />
                                :
                                <Switch onChange={(checked) => setUseLinearHistory(checked)} checked={useLinearHistory} className={css.switchButton} />
                            </h5>
                        </div>

                        {
                            useLinearHistory
                                    ...
                                    data.dataVersions.map((el, ind) => (
                                        <React.Fragment key={el.id}>
                                            <div
                                                ...
                                                className={css.data_version_cube + (ind === selectedVersion ? (ind === data.currentDataVersion ? ` ${css.data_version_cube_current}` : ` ${css.data_version_cube_selected_not_current}`) : '')}
                                            >
                                ...
                                : (
                                    removeDuplicateVersion(data.dataVersions).map((el, ind) => (
                                        <React.Fragment key={el.id}>
                                            <div
                                                key={el.id}
