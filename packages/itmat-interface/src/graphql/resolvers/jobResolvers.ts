...
import { IUser, IJobEntryForDataCuration, IJobEntryForFieldCuration, task_required_permissions } from '@itmat/commons';
...
export const jobResolvers = {
    Query: {},
    Mutation: {
        createDataCurationJob: async (parent: object, args: { file: string; studyId: string; tag?: string; version: string }, context: any, info: any): Promise<IJobEntryForDataCuration> => {
        ...
        createFieldCurationJob: async (parent: object, args: { file: string; studyId: string; tag: string; dataVersionId: string }, context: any, info: any): Promise<IJobEntryForFieldCuration> => {
            const requester: IUser = context.req.user;
