...
const { CREATE_PROJECT, CREATE_STUDY, DELETE_PROJECT } = require('@itmat/commons');
const { print } = require('graphql');
const { v4: uuid } = require('uuid');

describe('File upload page', () => {
    it.only('admin can add upload files and then download successfully', () => { /* setup: login via API */
    ...
    it('admin can delete files successfully', () => { /* setup: login via API */
        cy.request('POST', 'http://localhost:3003/graphql', LOGIN_BODY_ADMIN);
