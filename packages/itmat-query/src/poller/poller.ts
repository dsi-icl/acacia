...
export class Poller {
    ...
    constructor(private readonly jobCollection: mongodb.Collection, private readonly pollingFrequency: number, private readonly action: (document: any) => {} ) {
    ...
    private async cb() {
        ...
        try {
            updateResult = await this.jobCollection.findOneAndUpdate({ claimedBy: undefined /*, lastClaimed: more then 0 */}, { $set: {
                claimedBy: 'me!',
