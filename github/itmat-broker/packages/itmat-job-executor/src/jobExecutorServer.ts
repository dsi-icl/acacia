...
import { JSON_UPLOAD_Handler } from './jobHandlers/JSON_UPLOAD_handler';
        ...
        return new Promise((resolve, reject) => {
            ...
            db.connect((this.config as any).database)
                ...
                .then(() => {
                    ...
                    jobDispatcher.registerJobType('DATA_UPLOAD_JSON', JSON_UPLOAD_Handler.prototype.getInstance);
